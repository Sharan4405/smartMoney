  ...
  return (
    <>
      ...
      <section className="py-20 sm:py-24">
        <Container className="grid grid-cols-1 gap-14 lg:grid-cols-2 lg:items-start">
          <Reveal>
            <div className="flex flex-col gap-6">
              <h2 className="text-3xl font-bold text-primary sm:text-4xl">Smart advice, built on discipline</h2>
          ...
          <Reveal className="rounded-lg bg-bg-alt p-9">
            <div className="flex flex-col gap-5">
              ...
              <dl className="flex flex-col gap-5">
                <div>
                  ...
                  <dd className="text-lg font-medium text-primary">{COMPANY.name}</dd>
                </div>
                <div>
                  <dt className="text-sm text-muted">Director</dt>
                  <dd className="text-lg font-medium text-primary">{COMPANY.director}</dd>
                </div>
                <div>
      ...
      <section className="bg-bg-alt py-20 sm:py-24">
        <Container className="flex flex-col gap-12">
          <Reveal>
            <h2 className="text-3xl font-bold text-primary sm:text-4xl">What we stand for</h2>
          </Reveal>
